...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 26 16:42:07 2021
...
def attri_to_level(score):
    # quantifies original continuous emotional attribute scores into E=6-levels
...
if os.path.exists('./curriculum_metric'):
    pass
else:    
...
# load trained model (either the provide pretrained models or the new trained models)
# MODEL_PATH = './Models/ResNetDeepEmoCluster_epoch'+str(epochs)+'_batch'+str(batch_size)+'_'+str(num_clusters)+'clusters_'+emo_attr+'.pth.tar'
...
for i in tqdm(range(len(_paths))):
    ...
    pred_attri = (Label_std*pred_attri)+Label_mean
    # output
